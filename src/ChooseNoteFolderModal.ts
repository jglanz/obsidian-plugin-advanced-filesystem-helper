...
export default class ChooseNoteFolderModal extends FuzzySuggestModal<TFolder> {
	...
	init() {
		...
		this.folderPathMap = sortedFolders.reduce((map, folder) => ({ ...map, [folder.path]: folder }), {} as FolderPathMap)
